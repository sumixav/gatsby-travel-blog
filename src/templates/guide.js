...
const Archive = (props) => {
    ...
    const { currentPage, noOfPages } = props.pageContext
    ...
    window.location.href.indexOf('category/guide')

    return (
        <Layout>
        <SEO title='Guide Blog' keywords={['guide', 'guide blog', 'guide photography']} />
        <Nav />
